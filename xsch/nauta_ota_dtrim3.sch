...
N 830 -450 850 -450 {lab=out_p}
N 850 -450 850 -330 {lab=out_p}
N 450 -430 450 -310 {lab=out_n}
N 450 -430 530 -430 {lab=out_n}
N 500 -370 500 -250 {lab=gnd}
N 500 -370 530 -370 {lab=gnd}
N 480 -390 480 -270 {lab=sw_n}
N 480 -390 530 -390 {lab=sw_n}
N 470 330 470 440 {lab=vdd}
N 470 440 530 440 {lab=vdd}
N 530 440 530 460 {lab=vdd}
N 510 350 510 480 {lab=out_p}
N 510 480 530 480 {lab=out_p}
N 480 410 480 520 {lab=sw_n}
N 480 520 530 520 {lab=sw_n}
N 500 460 500 540 {lab=gnd}
N 500 540 530 540 {lab=gnd}
N 830 460 870 460 {lab=out_n}
N 870 330 870 460 {lab=out_n}
N 470 -290 530 -290 {lab=vdd}
N 470 370 530 370 {lab=vdd}
N 440 -410 530 -410 {lab=sw_p}
N 440 -410 440 -290 {lab=sw_p}
N 440 500 530 500 {lab=sw_p}
N 440 390 440 500 {lab=sw_p}
...
C {cc_inv_dt05_long.sym} 680 -410 0 0 {name=x11}
C {cc_inv_dt05_long.sym} 680 500 0 0 {name=x12}
