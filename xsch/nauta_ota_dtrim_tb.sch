...
N -410 -150 -140 -150 {lab=#net1}
N -290 -190 -290 -50 {lab=#net3}
N -290 10 -290 50 {lab=GND}
N -240 -170 -240 -50 {lab=#net4}
N -240 -170 120 -170 {lab=#net4}
N 120 -10 130 -10 {lab=#net4}
N -240 10 -240 50 {lab=GND}
N 120 -170 120 -10 {lab=#net4}
N 60 -30 130 -30 {lab=#net3}
N 60 -190 60 -30 {lab=#net3}
N -290 -190 60 -190 {lab=#net3}
...
C {nauta_ota_dtrim3.sym} 280 -40 0 0 {name=x1}
