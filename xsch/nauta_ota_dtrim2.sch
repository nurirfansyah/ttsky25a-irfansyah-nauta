...
N 830 330 870 330 {lab=out_n}
N 870 210 870 330 {lab=out_n}
N 830 -330 850 -330 {lab=out_p}
N 850 -330 850 -210 {lab=out_p}
N 450 -310 450 -190 {lab=out_n}
N 450 -310 530 -310 {lab=out_n}
N 510 230 510 350 {lab=out_p}
N 510 350 530 350 {lab=out_p}
N 470 330 530 330 {lab=vdd}
N 470 210 470 330 {lab=vdd}
N 500 410 530 410 {lab=gnd}
N 470 -330 470 -230 {lab=vdd}
N 470 -330 530 -330 {lab=vdd}
N 500 -250 500 -130 {lab=gnd}
N 500 -250 530 -250 {lab=gnd}
N 440 -170 530 -170 {lab=sw_p}
N 440 -290 440 -170 {lab=sw_p}
N 440 -290 530 -290 {lab=sw_p}
N 480 -270 480 -150 {lab=sw_n}
N 480 -270 530 -270 {lab=sw_n}
N 440 370 530 370 {lab=sw_p}
N 480 390 530 390 {lab=sw_n}
...
C {cc_inv_dt05.sym} 680 -290 0 0 {name=x9}
C {cc_inv_dt05.sym} 680 370 0 0 {name=x10}
